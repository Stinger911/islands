<template>
  ...
  <q-dialog ref="dialogRef" @hide="onDialogHide">
    <q-card class="q-dialog-plugin" style="background-color: #4e4e4e">
      ...
      <q-card-section>
        Visual representation inspired by
        <a
          target="_blank"
          href="https://github.com/gregorterrill/d6"
          class="text-grey-3 text-weight-bold"
        >
          PipQuest
        </a>
        project by <b>Gregor Terrill</b>. A lot og graphics were copied from
        there too.
      </q-card-section>
      ...
      <q-card-section v-if="inGame">
        ...
        <div
          class="
            ...
            text-purple-11 text-weight-bolder text-center
          "
        >
          {{ inGame }}
        </div>
