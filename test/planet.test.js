...
describe("Planet Generation Tests", () => {
  ...
  it("Make lines", () => {
    const plane = fillPlane(9, .2, rng, 0, 0);
    console.log("|" + plane.join("|\n|") + "|");
  })

  it("Make spots", () => {
    const plane = fillPlane(9, .2, rng, 1, 1);
    console.log("|" + plane.join("|\n|") + "|");
  })

  it("Make random", () => {
    const plane = fillPlane(9, .2, rng);
    console.log("|" + plane.join("|\n|") + "|");
  })

  it("Make random small", () => {
    const plane = fillPlane(5, .2, rng);
    console.log("|" + plane.join("|\n|") + "|");
  })
  ...
  it("Make big planet", () => {
    ...
    for(let r = 0; r < sz; r++) {
        ...
        out = out + planet.faces[1][r];
        out = out + planet.faces[2][r];
        out = out + "\n";
    }
    for(let r = 0; r < sz; r++) {
        out = out + pad + planet.faces[5][r] + "\n";
    }
    console.log(out);
  })
